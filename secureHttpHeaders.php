...
$callbackServers = isset($_SESSION['environment'])? $_SESSION['environment'] : implode(" ", $siteConfigs['cloudEnvs']);
...
header('access-control-allow-origin: ' . $siteConfigs['website_www'] . $callbackServers) ;
